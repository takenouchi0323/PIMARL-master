...
import functools
from models import graph_net, mlp_net, invariant_nets
...
MODEL_MAP = {
    ...
    'deepset': invariant_nets.DeepSet,
    'deepset2': invariant_nets.DeepSet2,
    'vdn': invariant_nets.ValueDecomposition
}

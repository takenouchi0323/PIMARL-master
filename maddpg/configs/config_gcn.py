...
def get_config():
    ...
    config.alg.critic_lr = 0.01 #* 学習率，シナリオによる
    ...
    config.env.scenario = 'simple_tag_n3'#* 'simple_spread_n?', 'simple_spread2_n?', 'simple_push_n?', 'simple_tag_n?'
    ...
    config.main.exp_name = 'coop_spread2_n3_test'
    config.main.save_dir = './ckpt_plot_spread2'
    config.main.seed = 12340
    config.main.render_episodes = None #何エピソードから描画するか，Noneで描画なし
